...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Bulan Mei 2025 pada 10.53
...
INSERT INTO `aset` (`id_aset`, `nama_aset`, `kategori_id`, `lokasi_id`, `tanggal_perolehan`, `nilai_awal`, `status`, `nilai_susut`) VALUES
(10, 'monitor', 1, 1, '2020-01-13', 10000000.00, 'Aktif', 200000),
(11, 'komputer', 1, 2, '2021-01-13', 1000000.00, 'Aktif', 0),
(12, 'hp', 1, 1, '2024-01-13', 1000000.00, 'Aktif', 0);
...
(32, 12, '2025', 200000.00, 800000.00);
...
(2, 'Admin ', 'admin@mail.com', 'surya123', 'admin'),
(3, 'Staf User', 'staf@mail.com', 'surya123', 'staf'),
(4, 'Pimpinan User', 'pimpinan@example.com', 'surya123', 'pimpinan');
...
--
ALTER TABLE `penyusutan`
  MODIFY `id_penyusutan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
