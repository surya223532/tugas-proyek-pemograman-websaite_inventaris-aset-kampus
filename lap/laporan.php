...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            labels: labels,
            datasets: [
                { label: 'Nilai Awal', data: nilaiAwal, backgroundColor: 'rgba(54, 162, 235, 0.6)' },
                { label: 'Nilai Penyusutan', data: nilaiSusut, backgroundColor: 'rgba(255, 99, 132, 0.6)' }
            ]
        },
        options: {
            responsive: true,
            plugins: {
                legend: { position: 'top' },
                title: { display: true, text: 'Perbandingan Nilai Aset dan Penyusutan' }
            },
            scales: {
                y: {
                    beginAtZero: true,
